...
<body>
     ...
     <div class="uk-flex uk-flex-center logincard uk-width-1-1@m">
          <div class="uk-card uk-card-default uk-card-body  uk-width-1-2@m uk-animation-slide-top-small">
               ...
               <div class="uk-text-large uk-text-center uk-text-primary">6 | 3</div>
               <div class="uk-text-small uk-text-center">Term & Condition</div>
                    ...
                    <form action="../view/reg4.html" method="POST">
                         ...
                         <ul class="uk-switcher uk-margin uk-text-center">
                              <li>
                                   ...
                                   <div><a uk-toggle="target: #terms"> Read Term and
                                             Condtions</a><br>
                                   ...
                                   <div class="uk-align-right">
                                        <button class="uk-button uk-button-default uk-text-bold regbtn" type="submit">I
                                             Agreed<i class="fas fa-check-circle uk-margin-small-left"></i></button>
                              </li>
                              ...
                              <li>
                                   ...
                                   <br>
                                   <div class="uk-align-right">
                                        <button class="uk-button uk-button-default uk-text-bolder regbtn"
                                             type="submit">මා එකග වෙමි<i
                                                  class="fas fa-check-circle uk-margin-small-left"></i></button>
                              </li>
               ...
               <div class="uk-align-left">
                    <a href="../view/reg2.html" class="uk-button uk-button-default uk-text-bold backbtn"><i
