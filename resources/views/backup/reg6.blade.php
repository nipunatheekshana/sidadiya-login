...
<body>
     ...
     <div class="uk-flex uk-flex-center logincard uk-width-1-1@m">
          <div class="uk-card uk-card-default uk-card-body  uk-width-1-2@m uk-animation-slide-top-small">
               ...
               <div class="uk-text-small uk-text-center">Finish</div>

               <div class="uk-child-width-1-1@s" uk-grid>

                    <form action="../view/login.html" class="uk-text-center" method="POST">

                         <div class="uk-align-center">
                              <img src="../assets/done.svg" alt="" width="400" uk-img>
                         </div>
                        <div class="uk-text-large finish ">You successfully registered to<br><b class="uk-text-secondary">SIDADIYA</b></div>
                         

                         <div class="uk-align-right">
                              <button class="uk-button uk-button-default uk-text-bold loginbtn" type="submit">Login<i
                                        class="fas fa-lock uk-margin-small-left"></i></button>
                         </div>
                         <div class="uk-align-left">
                              <a href="../view/reg5.html" class="uk-button uk-button-default uk-text-bold backbtn"><i
